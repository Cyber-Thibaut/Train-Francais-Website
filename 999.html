...
<html lang="fr">
	...
	<head>
		...
		<meta name="twitter:card" content="img/logo/Bus Français.png" />
		<meta name="twitter:title" content="Bus Français" />
		<meta name="twitter:description" content="Bus Français, une compagnie du jeu Transport Manager" />
		<meta name="twitter:image" content="img/logo/Bus Français.png" />
		<meta property="og:type" content="object" />
		<meta property="og:url" content="https://franceavenir.vercel.app" />
		<meta property="og:title" content="Bus Français" />
		<meta property="og:description" content="Bus Français, une compagnie du jeu Transport Manager" />
		<meta property="og:image" content="img/logo/Bus Français.png" />
                            ...
                            <div class="collapse navbar-collapse navbar-collapse">
                                    <ul class="nav navbar-nav navbar-right">
                                                    ...
                                                    <div class="submenu-wrapper">
                                                            <div class="submenu-inner">
                                                                    <ul class="dropdown-menu">
                                                                            ...
                                                                            <li><a href="blog.html">Nos ventes privées</a></li>
                                                                            <li><a href="infotrafic.html">Info Trafic</a></li>
                                                                    </ul>
                                                            </div>
                                                    </div>
                                                    <!-- /submenu-wrapper -->
                                            ...
                                            <!-- MEGA MENU -->
                                                    ...
                                                    <li><a href="départ.html#V">Clermont-Ferrand</a></li>
                                                                                                                    </ul>
                                                                                                            </div><!-- /.col--> 
                                                                                                    </div><!-- /.row -->
                                                                                            </div><!-- /.mega-content -->
			        ...
			        <footer class="copyright-section">
			        	<div class="container text-center">
			        		<div class="copyright-info">
			        			<span>Copyright &copy; 2020-<script>document.write(new Date().getFullYear());</script> All rights reserved | Ce site a été fait avec ❤️ par Thibaut pour <a href="Index.html" target="_blank">Bus Français Compagny</a><h1 class="logo"><img src="img/logo/Bus Français.png" alt=""></a></h1>
			        		</div>
			        	</div><!-- /.container -->
			        </footer>
